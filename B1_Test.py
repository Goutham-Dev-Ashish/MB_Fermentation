...
file_path = '/Users/goutham/Desktop/Mercury Bio/Fermentation Data/MB24/MB_24_Power Query/MB24 B1/MB24-B1/MB24-24-B1/MB24-24-B1-PLOTTED.xlsx'
...
charts_info = [
    ...
    (worksheet, run_number + " DO, LPM", 'Process Time', ' ', 1, [9, 2], ["pO2", "AIRSPEED"], ["0000FF", "FF0000"], worksheet.max_row + 2, 'H'),
    (worksheet, run_number + " DO,rpm", 'Process Time', ' ', 1, [9, 11], ["pO2", "STIRRER"], ["0000FF", "FF0000"], worksheet.max_row + 2, 'O'),
    ...
    (worksheet, run_number + " DO:-SAT,VAL", 'Process Time', ' ', 1, [9, 10], ["pO2_%SAT", "pO2_VAL"], ["0000FF", "FF0000"], worksheet.max_row + 20, 'O'),
